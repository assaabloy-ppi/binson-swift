...
class BuilderTests: XCTestCase {
    ...
    func testUnpackEmptyDataBinson() {
        ...
        if let b1 = Builder.unpack(data: emptyData) {
    ...
    func testUnpackBadDataBinson() {
        ...
        if let b1 = Builder.unpack(data: badData) {
            XCTAssert(false, "\(b1) - Should have been empty")
        } else {
    ...
    func testUnpackEmptyObjectDataBinson() {
        ...
        if let b1 = Builder.unpack(data: basicData) {
    ...
    func testUnpackBinsonInBinson() {
        ...
        if let b1 = Builder.unpack(data: binsonData) {
    ...
    func testUnpackBinsonUnlock() {
        ...
        if let b4 = Builder.unpack(hex: inputHexB1) {
            XCTAssertEqual(b4.hex, bn.hex)
        } else {
            XCTAssert(false, "Hepp")
        }

        if let b5 = Builder.unpack(hex: inputHexB2) {
    ...
    func testUnpackBinson() {
        ...
        if let b1 = Builder.unpack(hex: emptyHexA1) {
            XCTAssert(false, "\(b1) - Should have been empty")
        } else {
            XCTAssert(true, "Hepp")
        }

        if let b2 = Builder.unpack(hex: emptyHexA2) {
            XCTAssert(false, "\(b2) - Should have been empty")
        } else {
            XCTAssert(true, "Hepp")
        }

        if let b3 = Builder.unpack(data: emptyData) {
            XCTAssert(false, "\(b3) - Should have been empty")
        } else {
            XCTAssert(true, "Hepp")
        }

        if let b4 = Builder.unpack(hex: inputHexA1) {
            XCTAssertEqual(b4.hex, Binson().hex)
        } else {
            XCTAssert(false, "Hepp")
        }

        if let b5 = Builder.unpack(hex: inputHexA2) {
            XCTAssertEqual(b5.hex, Binson().hex)
        } else {
            XCTAssert(false, "Hepp")
        }

        if let b4 = Builder.unpack(data: inputData) {
            XCTAssertEqual(b4.hex, Binson().hex)
        } else {
            XCTAssert(false, "Hepp")
        }
    ...
    func testUnpackBytes() {
        ...
        if let unlock = Builder.unpack(data: inputData) {
    ...
    func testStaticJSONtoBinson() {
        ...
        let bn = try! Builder.unpack(jsonString: json)
